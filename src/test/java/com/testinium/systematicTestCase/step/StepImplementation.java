...
public class StepImplementation {
    ...
    @Step("<key> 9Saat kontrol")
    public void dokuzsaat(String key){

        for (int i = 0; i < 700; i++) {
            methodsUtil.waitBySeconds(50);
            checkElementVisible(key,30);
        }
    }

    @Step("<key> 7Saat kontrol")
    public void yediSaat(String key) {
        for (int i = 0; i < 504; i++) {
            methodsUtil.waitBySeconds(50);
            checkElementVisible(key, 30);
        }
    ...
    @Step("<key> 5Saat kontrol")
    public void besSaat(String key) {
        for (int i = 0; i < 360; i++) {
            methodsUtil.waitBySeconds(50);
            checkElementVisible(key, 30);
        }
    ...
    @Step("<key> 3Saat kontrol")
    public void ucSaat(String key) {
        for (int i = 0; i < 216; i++) {
            methodsUtil.waitBySeconds(50);
            checkElementVisible(key, 30);
        }
    ...
    @Step("<key> 1Saat kontrol")
    public void birSaat(String key) {
        for (int i = 0; i < 72; i++) {
            methodsUtil.waitBySeconds(50);
            checkElementVisible(key, 30);
        }
    ...
    @Step("<key> YarımSaat kontrol")
    public void yarimSaat(String key) {
        for (int i = 0; i < 36; i++) {
            methodsUtil.waitBySeconds(50);
            checkElementVisible(key, 30);
        }
    ...
    @Step("<key> CeyrekSaat kontrol")
    public void ceyrekSaat(String key) {
        for (int i = 0; i < 18; i++) {
            methodsUtil.waitBySeconds(50);
            checkElementVisible(key, 30);
        }
    ...
    @Step("<key> OnDakika kontrol")
    public void onDakika(String key) {
        for (int i = 0; i < 12; i++) {
            methodsUtil.waitBySeconds(50);
            checkElementVisible(key, 30);
        }
